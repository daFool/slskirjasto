				...
				<section class='col-xs-12 col-sm-6 col-md-6'>
					...
					<form id="hakuehto" method="POST" class="form-horizontal">
						...
						<div class="form-group" id="nimig">
							<label for="nimi" class="control-label col-xs-2"><?php echo _("Nimi:");?></label>
							...
							<p class="help-block"><?php echo _("Pelin nimi, korkeintaan 255 merkkiä.");?></p>
						</div>
					
						<!-- Suunnittelija -->
						<div class="form-group" id="suunnittelijag">
							<label class="control-label col-xs-3" for="suunnittelija"><?php echo _("Suunnittelija:");?></label>
						...
						<div class="form-group" id="pelaajiag">
							<div class="row">
								<div class="col-xs-2">
									<label class="control-label col-xs-2" for="pelaajia"><?php echo ("Pelaajia:");?></label>
								</div>
								<div class="col-xs-4">
									<input type="number" class="form-control" min="1" max="99" size="2" id="minpelaajia"/>
								</div>
								<div class="col-xs-2"><p class="form-control-static">-</p></div>
								<div class="col-xs-4">
