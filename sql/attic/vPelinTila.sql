...
select coalesce(l.lainattu,'1970-01-01 01:02:03') as pt_lainattu, coalesce(lainaaja, to_char(l.kortti,'9999999')) as pt_lainaaja,
...
p.kesto as pt_kesto, p.pelaajia as pt_pelaajia, p.bggrank as pt_bggrank, p.score as pt_score, p.age as pt_age, kp.tunniste as pt_tunniste, p.bgglinkki as pt_bgg,
kp.huomautus as huomautus, kortti as pt_kortti, lainaaja
